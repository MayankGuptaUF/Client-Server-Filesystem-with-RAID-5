...
def get_data_block(block_number, offset, length):
    return ''.join(client_stub.get_data_block(block_number, offset, length))
...
def free_data_block(block_number, server):
    client_stub.free_data_block(block_number, server)
def free_data_block_id(block_number, server):
    client_stub.free_data_block(block_number, server)

#REQUEST TO WRITE DATA ON THE THE SERVER
def update_data_block(block_number, block_data, slice_number):
    client_stub.update_data_block(block_number, block_data, slice_number)
